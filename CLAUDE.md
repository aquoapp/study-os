...
Authorization, en `phase/3-learning-engine` desde `main` `8a21fc2`, y **aceptado y congelado
el 2026-09-16**: PR #13 integrado en `main` (`f5d0b10`, árbol idéntico al candidato aceptado
`2ea5038`), tag anotado `phase-3-v1.0`. Checkpoint **PASS WITH DEBT** en
`docs/PHASE_3_CHECKPOINT.md`, con los **diez gates P3-G1 … P3-G10 en PASS**.
...
pausado por ser un proyecto Free sin uso y no se reactiva. **Phase 3 · FROZEN · PASS WITH
...
**Phase 3.1 · corrección D-26 · construida el 2026-09-16, aceptada y congelada el 2026-09-17.** La reconciliación de
...
y sin semántica nueva. **PHASE 3.1 · FROZEN · PASS WITH DEBT**: PR #15 integrado en `main`
...
**BUILD de Phase 4A · 2026-09-19 · FROZEN · PASS WITH DEBT.** Construido en
`phase/4a-planner-domain` desde `a96cafc`, **aceptado por Ana tras revisión independiente y
congelado el mismo día**: PR #19 integrado en `main` (`5a8f603`, árbol idéntico al candidato
aceptado `120d166`), tag anotado `phase-4a-v1.0` (`docs/PHASE_4A_CHECKPOINT.md` §P). Contenido: migración 22
...
`planner_items`, `planner_run_audit`, FK RESTRICT de la sesión y una sola sesión abierta por
persona) y el módulo real `apps/web/src/server/planner`, que **ninguna ruta consume**: la

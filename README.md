...
> `docs/PHASE_2_CHECKPOINT.md`). Phase 1B, Phase 3 y FPS no autorizados. Ningún motor,
> ninguna pantalla de producto más allá del onboarding mínimo y ningún contenido oficial: el
> corpus del primer pack no entra en este repositorio público. Ver

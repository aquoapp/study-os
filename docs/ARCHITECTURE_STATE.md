...
**Versión:** 9.0 · copia viva
**Última actualización:** 2026-09-07 · ronda de gobernanza · Human Decision Packet v1.0
...
| Tests unitarios | **641 · todos ejecutados y en verde** | 30 ficheros. Recuento verificable con `vitest --reporter=json`. La auditoría anterior contó 536 en 28; esta ronda añade `adr.acceptedDecisions.spec` (60) y `decisionRegister.spec` (45) |
...
Condición para reevaluar: MI-05a y un entorno con Docker, para ejecutar los cuatro
checks bloqueados con credenciales reales y verificación de limpieza. Ya no condiciona
ninguna decisión humana de dominio. Con eso resuelto, el estado esperado es

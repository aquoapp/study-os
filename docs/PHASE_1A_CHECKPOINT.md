...
| **D-17** · Las filas de auditoría de `ingest.staged_items` e `ingest.promotions` sobreviven a la purga de los packs sintéticos en STAGING (por diseño: la purga elimina contenido, no auditoría). Tras esta ronda quedan 128 y 113 filas, todas GENERATED y sin contenido canónico enlazado | Nueva · aceptable · política de retención de auditoría pendiente (entrada de Phase 1B / operación) |
